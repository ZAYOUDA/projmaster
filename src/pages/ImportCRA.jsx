...
const S = {
  ...
  select: { fontSize: 13, padding: '5px 8px', border: `1px solid ${C.line}`, borderRadius: 6, background: C.bg, color: C.ink, maxWidth: 220 },
  input: { fontSize: 13, padding: '5px 8px', border: `1px solid ${C.line}`, borderRadius: 6, width: 70, textAlign: 'right', background: C.bg, color: C.ink },
